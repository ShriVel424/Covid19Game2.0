...
function draw() {
 ...
 /* if((touches.length > 0 || keyDown("SPACE")) && girl.collide(invisibleGround)) { 
  ...
  textSize(20);
  fill("red");
  text("                                                                             Simply wearing a mask and getting vaccinated can save a million lives!", 10,windowHeight-250);
  text("                                                                                 Stay Home, Stay Safe, and Let's End this Battle Against Humanity!", 10,windowHeight-230);
}
